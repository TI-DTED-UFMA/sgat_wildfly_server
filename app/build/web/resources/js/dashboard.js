...
//        });
    ...
    $a( document.body ).on("click", "#btn-more-dates", function () {
       
        //var selected = $a(this).find("option:selected").val();
        
        if($a('#formAtividade\\:dt').val()!=null && $a('#formAtividade\\:dt').val()!=""){
            console.log("rntrando");
            if(datesStatus == false){
               $a('#formAtividade\\:panel-dates').slideToggle('slow');
               $a("#btn-more-dates").removeClass("btn-success fa-plus");
               $a("#btn-more-dates").addClass("btn-warning fa-remove");
               $a("#formAtividade\\:dates-control").val(true);
               datesStatus = true;
              // alert('desgraça');
            }
            else
            {
               $a('#formAtividade\\:panel-dates').slideUp('fast');
               $a("#btn-more-dates").addClass("btn-success fa-plus");
               $a("#btn-more-dates").removeClass("btn-warning fa-remove");
               $a("#formAtividade\\:dates-control").val(false);
               datesStatus = false;
            }
        }
...
function setInstSelected(form){  
    document.getElementById('formResponsavel:instituicaoShowName').value = document.getElementById(form + ':instituicao_label').innerHTML;
    document.getElementById('formResponsavel:instituicao').value = document.getElementById(form + ':instituicao_input').value;
};
