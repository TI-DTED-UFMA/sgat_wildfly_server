...
public class ObjetoAprendizagemController implements Serializable {
    ...
    public void prepareList() throws FileNotFoundException, UnsupportedEncodingException, JSONException, SftpException {
        ...
        for(ObjetoAprendizagem o : objetos){
            ...
            List<Presenca> presencas = ejbparts.findByAtividade(o.getAtividade());
            ...
            j.put("qtdEstados", getQtdOfDistinctStates(o.getAtividade()));
            j.put("qtdMun", getQtdOfDistinctCities(o.getAtividade()));
    ...
    public int getQtdOfDistinctCities(Atividade atv){
        List<Municipio> list = ejbparts.findDistinctCities(atv);
