...
public class PresencaFacade extends AbstractFacade<Presenca> {
    ...
    public List<Presenca> findByArividadeInOrderedLocation(Atividade atv){
        TypedQuery query = em.createNamedQuery("Presenca.findByAtividadeOrderedByLocal", entities.Presenca.class);
        query.setParameter("atividade", atv);
        return query.getResultList();
    }
