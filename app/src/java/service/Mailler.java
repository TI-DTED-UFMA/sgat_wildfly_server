...
public class Mailler {
    ...
    private static final String SMTP_AUTH_PWD  = "GZFxTx6Y3KK5itk";
    
    public static boolean send(String email, String filePath, File slides, PresencaKeys key, boolean isSendCert){  
        try {
            boolean debug = false;
